...
class PipelineManager():
    ...
    def evaluate(self, pipeline_name, dev_mode, chunk_size):
        ...
        prediction = generate_prediction(meta_valid, pipeline, self.logger, CATEGORY_IDS, CATEGORY_LAYERS, chunk_size)
    ...
    def predict(self, pipeline_name, dev_mode, submit_predictions, chunk_size):
        ...
        pipeline = PIPELINES[pipeline_name]['inference'](SOLUTION_CONFIG)
        prediction = generate_prediction(meta_test, pipeline, self.logger, CATEGORY_IDS, CATEGORY_LAYERS, chunk_size)
